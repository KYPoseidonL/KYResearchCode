...
extern NSString *const fmSSKeychainErrorDomain;

/** Account name. */
extern NSString *const fmSSKeychainAccountKey;
 ...
 */
extern NSString *const fmSSKeychainCreatedAtKey;

/** Item class. */
extern NSString *const fmSSKeychainClassKey;

/** Item description. */
extern NSString *const fmSSKeychainDescriptionKey;

/** Item label. */
extern NSString *const fmSSKeychainLabelKey;

/** Time the item was last modified.
 
 The value will be a string.
 */
extern NSString *const fmSSKeychainLastModifiedKey;

/** Where the item was created. */
extern NSString *const fmSSKeychainWhereKey;
