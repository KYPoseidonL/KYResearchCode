...
NSString *const fmSSKeychainErrorDomain = @"com.samsoffes.sskeychain";

NSString *const fmSSKeychainAccountKey = @"acct";
NSString *const fmSSKeychainCreatedAtKey = @"cdat";
NSString *const fmSSKeychainClassKey = @"labl";
NSString *const fmSSKeychainDescriptionKey = @"desc";
NSString *const fmSSKeychainLabelKey = @"labl";
NSString *const fmSSKeychainLastModifiedKey = @"mdat";
NSString *const fmSSKeychainWhereKey = @"svce";

#if __IPHONE_4_0 && TARGET_OS_IPHONE  
CFTypeRef SSKeychainAccessibilityType = NULL;
#endif

@interface KYKeychain ()
...
+ (NSArray *)accountsForService:(NSString *)service error:(NSError **)error
{
    ...
    if (status != noErr && error != NULL) {
		*error = [NSError errorWithDomain:fmSSKeychainErrorDomain code:status userInfo:nil];
		return nil;
	}
