...
- (void)setKy_textHeightChangeBlock:(void (^)(NSString *, CGFloat))ky_textHeightChangeBlock {
    _ky_textHeightChangeBlock = ky_textHeightChangeBlock;
...
- (void)textDidChange {
    ...
    if (_textH != height) { // 高度不一样，就改变了高度
        ...
        if (_ky_textHeightChangeBlock && self.scrollEnabled == NO) {
            _ky_textHeightChangeBlock(self.text,height);
