...
@interface KYInputViewController ()
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *bottomCons;
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *bottomHCons;
@property (weak, nonatomic) IBOutlet KYTextView *inputView;
@end

@implementation KYInputViewController
...
- (void)setup {
    ...
    // 监听文本框文字高度改变
    _inputView.ky_textHeightChangeBlock = ^(NSString *text,CGFloat textHeight){
